...
import { Text, CloseIcon } from '@smartdev1990/newbrc-uikit'
  ...
  return (
    <Column style={{ width: '100%', flex: '1 1' }}>
      <PaddedColumn gap="14px">
        ...
        <RowBetween>
          <Text color='blue' fontSize="14px">{TranslateString(126, 'Token name')}</Text>
            ...
            <RowBetween>
              {selectedListInfo.current ? (
                <Row>
                  ...
                  <Text color='background' id="currency-search-selected-list-name">{selectedListInfo.current.name}</Text>
                </Row>
              ) : null}
              <LinkStyledButton
