...
import { Input, Text, Flex, Box } from '@smartdev1990/newbrc-uikit'
  ...
  return (
    <Box mb="16px">
      <Flex alignItems="center" mb="8px">
        <Text color='text' bold>{translateString(90, 'Transaction deadline')}</Text>
        <QuestionHelper
      ...
      <Field>
        ...
        <Text color='text' fontSize="14px" ml="8px">
          Minutes
        </Text>
      </Field>
      {error && (
