...
import { Box, Button, Flex, Input, Text } from '@smartdev1990/newbrc-uikit'
  ...
  return (
    <Box mb="16px">
      <Flex alignItems="center" mb="8px">
        <Text color='text' bold>{translateString(88, 'Slippage tolerance')}</Text>
        <QuestionHelper
      ...
      <Options>
        ...
        <Flex alignItems="center">
          ...
          <Option>
            <Text color='text' fontSize="18px">%</Text>
          </Option>
        </Flex>
      </Options>
      {error && (
