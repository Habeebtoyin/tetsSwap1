...
import { Card, CardBody, Text } from '@smartdev1990/newbrc-uikit'
  ...
  return (
    <Card>
      <CardBody>
        ...
        <RowBetween>
          <RowFixed>
            <Text color='text' fontSize='14px'>{TranslateString(226, 'Price Impact')}</Text>
            <QuestionHelper
              text={TranslateString(
                224,
        ...
        <RowBetween>
          <RowFixed>
            <Text color='text' fontSize="14px">{TranslateString(228, 'Liquidity Provider Fee')}</Text>
            <QuestionHelper
              text={TranslateString(
                230,
          ...
          {showRoute && (
            <>
              ...
              <AutoColumn style={{ padding: '0 24px' }}>
                <RowFixed>
                  <Text color='text' fontSize="14px">Route</Text>
                  <QuestionHelper
                    text={TranslateString(
                      999,
