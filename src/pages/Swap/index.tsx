...
import { CardBody, ArrowDownIcon, Button, IconButton, Text } from '@smartdev1990/newbrc-uikit'
...
const Swap = () => {
  ...
  const checkForWarning = useCallback(
    (selected: string, purchaseType: string) => {
      if (['GERT', 'SAFEMOON'].includes(selected)) {
        setTransactionWarning({
  ...
  return (
    <>
      ...
      />
      <SyrupWarningModal
        isOpen={transactionWarning.selectedToken === 'GERT'}
                ...
                <Card padding=".25rem .75rem 0 .75rem" borderRadius="20px">
                  <AutoColumn gap="4px">
                    ...
                    {allowedSlippage !== INITIAL_ALLOWED_SLIPPAGE && (
                      <RowBetween align="center">
                        <Text color='text' fontSize="14px">{TranslateString(88, 'Slippage Tolerance')}</Text>
                        <Text color='text' fontSize="14px">{allowedSlippage / 100}%</Text>
                      </RowBetween>
                    )}
                  </AutoColumn>
                </Card>
            ...
            <BottomGrouping>
              {!account ? (
                ...
                <GreyCard style={{ textAlign: 'center' }}>
                  <Text color='background' mb="4px">{TranslateString(1194, 'Insufficient liquidity for this trade.')}</Text>
                </GreyCard>
              ) : showApproveFlow ? (
                <RowBetween>
                  <Button
